            ...
            <div className="bg-white border-b border-gray-100">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                    <div className="flex items-center gap-3">
                        ...
                        <h1 className="text-xl font-bold text-gray-800">Library Saya</h1>
                    </div>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 py-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
                    ...
                    <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <p className="text-sm text-gray-500">Terakhir Dibaca</p>
                    ...
                    <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <p className="text-sm text-gray-500">Akan Kedaluwarsa</p>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 items-center justify-between">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <select
                                ...
                                className="px-4 py-2 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/30 bg-white"
                            >
                ...
                {loading && (
                    <div className="flex flex-col justify-center items-center h-64 space-y-4">
                        ...
                        <p className="text-gray-500 animate-pulse">Memuat library...</p>
                    </div>
                )}
                                    ...
                                    <div className="flex gap-4 p-4">
                                        ...
                                        <div className="flex-1 min-w-0 flex flex-col">
                                            <Link href={`/detail/${item.slug}`}>
                                                <h3 className="font-bold text-sm text-gray-800 line-clamp-2 group-hover:text-blue-600 transition-colors mb-1">
                                                    {item.title}
                                                </h3>
                                            </Link>
